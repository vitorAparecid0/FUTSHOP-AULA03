...
const App = () => {
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.linha}></View>
      <ScrollView>
        <RenderProducts title="Lançamentos" products={lançamentos} />
        <RenderProducts title="Europeus" products={europeus} />
        <RenderProducts title="Conjuntos" products={conjuntos} />
        <RenderProducts title="Chuteiras" products={chuteiras} />
        <RenderProducts title="Bolas" products={bolas} />
        <Footer />
      </ScrollView>
    </View>
  );
